...
public class Payment {
     ...
     */
    public Payment(int transactionId, String username, double amount, String dateTime) {
     ...
     * @throws SQLException The database did not update.
     */
    private static ResultSet updateFine(int fine, double amount, boolean full) throws SQLException {
        Connection connection = DBHelper.getConnection();
        if (full) {
