...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Book Sapiens = new Book(0, "Sapiens", 2017, null, "Noah", "Penguin Books", "educational", "111222333",
            "English");
        Book TheMartian = new Book(1, "The Martian", 2015, null, "Andy Weir", "Kane Books", "sci-fi", "333444555",
            "English");
